...
| 16 | Retrieval research: table chunking, agent-level eval, chunk size, embedder swap, summary nodes | **In progress** — 1 of 5 done (table chunking shipped, +0.09 hit@1); see `milestone-16.md` |
