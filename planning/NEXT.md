...
| 2 | `kb_list` tool: titles, overviews, chunk counts offered to the agent; opening prompts re-pointed at it | Gemini key on the laptop | ~$0.05 (agent harness on 5 global questions + starter prompts) | waiting on key |
